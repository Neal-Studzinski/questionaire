    ...
    handleSubmit (e, currentQuestionId) {
        ...
        this.refs.answerField.value = '';
            if (inputText != '' && inputText != undefined) {
                ...
                else this.props.history.push('/results')
                }
    ...
    render() {
        ...
        return (
            <section id = 'display' >
                ...
                <form>
                    <input type='text' ref='answerField' placeholder='Enter Answer Here' />
                    <button type='submit' onClick={(e) => this.handleSubmit(e, currentQuestionNumber)}>Submit</button>
                </form>
                <div>
                    <button type='button' onClick={() => this.handlePagination('previous', currentQuestionNumber)}>Previous</button>
                    <button type='button' onClick={() => this.handlePagination('next', currentQuestionNumber)}>Next</button>
                </div>
                <Nav />
            </section>
        );
